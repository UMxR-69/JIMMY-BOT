...
### `—◉ ✨ ACTIVAR EN HEROKU ✨`
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/UMxR-69/JIMMY-BOT)
```bash
...
### `—◉ ⚙️ AJUSTES ⚙️`
- CLONAR EL REPOSITORIO [Aqui](https://github.com/UMxR-69/JIMMY-BOT/fork)
- CAMBIAR NÚMERO DEL OWNER [Aqui](https://github.com/UMxR-69/TheMystic-Bot-MD/blob/master/config.js)
...
`JIMMY-BOT  ___________ By UMxR-69`
